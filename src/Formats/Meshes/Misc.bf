...
namespace RfgTools.Formats.Meshes
{
    ...
    {
        public MeshDataBlock Config;
        public Span<u8> VertexBuffer = .Empty;
        public Span<u8> IndexBuffer = .Empty;
    }

    public enum PrimitiveTopology : u8
    {
